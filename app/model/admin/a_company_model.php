...
class A_Company_Model extends \Model\A_Company_Concern
{
    ...
    public function getAll($page=0, $pagesize=10, $sortCol="id", $sortDir="ASC", $keyword="", $utype="", $is_vendor="")
    {
        ...
        $this->db->select_as("$this->tbl_as.alamat", "alamat");
        $this->db->select_as("$this->tbl_as.d_kabkota_id", "d_kabkota_id");
        $this->db->select_as("$this->tbl_as.d_provinsi_id", "d_provinsi_id");
