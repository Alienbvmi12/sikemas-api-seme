<div id="page-content">
	...
	<!-- Content -->
	<form id="fedit" action="<?=base_url_admin('kelasrombel/edit/'); ?>" method="post" enctype="multipart/form-data" class="" onsubmit="return false;">
		<div class="block full row">
			...
			<div class="form-group">
                ...
                <div class="col-md-6">
					<label for="iejenjang_kelas">Jenjang Kelas*</label>
					<select id="iejenjang_kelas" name="jenjang_kelas" class="form-control" required>
						<option value="">--pilih--</option>
                ...
                <div class="col-md-4">
					<label for="ienama">Nama Kelas*</label>
					<input id="ienama" type="text" name="nama" class="form-control" required>
				</div>
                <div class="col-md-4">
					<label for="iekonsentrasi">Konsentrasi</label>
					<input id="iekonsentrasi" type="text" name="konsentrasi" class="form-control">
				</div>
				<div class="col-md-4">
