...
<div id="page-content">
		...
		<div class="row" style="padding: 0.5em 2em;">
			...
			<div class="col-md-6">
				<div class="btn-group pull-right">
					<a id="aback" href="<?=base_url_admin('erpmaster/kelasrombel/baru/'); ?>" class="btn btn-info">
		...
		<div class="row" style="margin-bottom: 1em;">
			<div class="col-md-6">
				<div class="input-group">
					...
					<select id="filter_a_institusi_id" class="form-control input-select2">
	...
	<div class="block full">
		<div class="block-title">
			<h2><strong>Data Kelas Rombel</strong></h2>
		</div>
