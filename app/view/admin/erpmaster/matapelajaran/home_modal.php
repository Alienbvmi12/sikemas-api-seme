				...
				<form id="ftambah" action="<?=base_url_admin(); ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
					<fieldset>
						<div class="form-group">
							<label class="col-md-4 control-label" for="inama">Mata Pelajaran*</label>
							<div class="col-md-8">
								<input id="inama" type="text" name="nama" class="form-control" minlength="2" maxlength="" autocomplete="off" required />
							</div>
						</div>
					</fieldset>
					<fieldset>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="fedit" action="<?=base_url_admin(); ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onsubmit="return false;">
					<fieldset>
						<div class="form-group">
							<label class="col-md-4 control-label" for="ienama">Mata Pelajaran*</label>
							<div class="col-md-8">
                                <input type="hidden" id="ieid" value="" />
								<input id="ienama" type="text" name="nama" class="form-control" minlength="2" maxlength="" required />
							</div>
						</div>
					</fieldset>
					<fieldset>
