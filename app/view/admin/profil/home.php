	...
	<div class="block full row">
		<div class="block-title">
			<div class="block-options pull-right">
				...
				<button type="button" id="bpassword_change" href="#" class="btn btn-alt btn-sm btn-default" data-toggle="tooltip" title="Change Password" data-original-title="Change Password"><i class="fa fa-key"></i> Ganti Password</button>
			</div>
