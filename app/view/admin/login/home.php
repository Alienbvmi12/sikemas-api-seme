...
<img src="<?=$this->cdn_url($this->config->semevar->admin_login_bg ?? '')?>" alt="Login Full Background" class="full-bg animation-pulseSlow" onerror="this.onerror=null;this.src='<?=$this->cdn_url()?>media/backgroundcolor.jpg';">
<!-- END Login Full Background -->
	...
	<div id="login-container" class="animation-fadeIn">
		...
		<div class="login-title text-center">
			<img src="<?=$this->cdn_url($this->config->semevar->admin_login_logo ?? '')?>" class="img-responsive" onerror="this.onerror=null;this.src='<?=$this->cdn_url()?>media/logo-default3.png';" />
		</div>
		<!-- END Login Title -->
		...
		<div class="block push-bit">
			...
			<form action="<?=base_url_admin("login/proses"); ?>" method="post" id="form-login" class="form-horizontal form-bordered form-control-borderless">
				...
				<div class="form-group form-actions">
					<div class="col-xs-6">
						<label class="" style="color: grey; font-weight: lighter; font-size: smaller;">v<?=$this->config->semevar->site_version?></label>
					</div>
					<div class="col-xs-6 text-right">
						<button type="submit" class="btn btn-sm btn-danger btn-submit">Login <i id="icon-submit" class="fa fa-angle-right"></i></button>
					</div>
				</div>
						<!--
				<div class="form-group">
