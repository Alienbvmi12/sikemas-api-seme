<form id="ftambah" action="page_forms_components.html" enctype="multipart/form-data" method="post" class="form-horizontal form-bordered">
  <input type="hidden" name="utype" value="sumur_baru">
  <div class="row">
    <div class="col-md-12">
      <h1>Pembangunan Sumur baru</h1>
      <p>Silakan lengkapi form pelayanan rekomendasi teknis.</p>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <fieldset>
        ...
        <div class="form-group">
          <label class="col-md-4 control-label" for="ibukti_pembayaran_terakhir">Bukti pembayaran Terakhir</label>
          <div class="col-md-6">
            <div class="input-group">
              <input id="ibukti_pembayaran_terakhir" type="file" name="bukti_pembayaran_terakhir" class="form-control" placeholder="Bukti Pembayaran Terkhir" accept=".pdf">
              <span class="input-group-addon"><i></i></span>
            </div>
          </div>
        </div>
        ...
        <div class="form-group">
          <label class="col-md-4 control-label" for="inpwp2">NPWP</label>
          <div class="col-md-6">
            <div class="input-group">
        ...
        <div class="form-group">
          <label class="col-md-4 control-label" for="iemail2">Email</label>
          <div class="col-md-6">
            <div class="input-group">
  ...
  <div class="row">
    <div class="col-md-12">
      <fieldset>
        ...
        <div class="form-group">
          <label class="col-md-4 control-label" for="itujuan_penggunaan">Tujuan Penggunaan</label>
          <div class="col-md-6">
            <div class="input-group">
              <input type="text" id="itujuan_penggunaan" name="tujuan_penggunaan" class="form-control" placeholder="Tujuan Penggunaan">
              <span class="input-group-addon"><i></i></span>
            </div>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">
            <div class="input-group">
              <input type="text" id="irencana_volume_pengambilan" name="rencana_volume_pengambilan" class="form-control" placeholder="Rencana Volume Penambilan">
              <span class="input-group-addon"><i></i></span>
            </div>
          </div>
        </div>
        ...
        <div class="form-group">
          <label class="col-md-4 control-label" for="irencana_volume_pengambilan_perbulan">Rencana Volume Pengambilan Perbulan</label>
          <div class="col-md-6">
            <div class="input-group">
              <input type="text" id="irencana_volume_pengambilan_perbulan" name="rencana_volume_pengambilan_perbulan" class="form-control" placeholder="Rencana Volume Pengambilan Perbulan">
              <span class="input-group-addon"><i></i></span>
            </div>
          </div>
        </div>
        ...
        <div class="form-group">
          <label class="col-md-4 control-label" for="ijangka_waktu_yang_di_mohonkan">Jangka Waktu Yang Di Mohonkan</label>
          <div class="col-md-6">
            <div class="input-group">
              <input type="text" id="ijangka_waktu_yang_di_mohonkan" name="jangka_waktu_yang_di_mohonkan" class="form-control" placeholder="Jangka Waktu Yang Di Mohonkan">
              <span class="input-group-addon"><i></i></span>
            </div>
          </div>
        </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <fieldset>
        ...
        <div class="form-group">
          <label class="col-md-4 control-label" for="iperusahaan_perencana_sumur">Perusahaan Perencana Sumur (Survey Geolistriks)</label>
          <div class="col-md-6">
            <div class="input-group">
              <input type="text" id="iperusahaan_perencana_sumur" name="perusahaan_perencana_sumur" class="form-control" placeholder="Perusahaan Perencana Sumur (Survey Geolistriks)">
              <span class="input-group-addon"><i></i></span>
            </div>
          </div>
        </div>
        ...
        <div class="form-group">
          <label class="col-md-4 control-label" for="inpwp3">NPWP</label>
          <div class="col-md-6">
            <div class="input-group">
        ...
        <div class="form-group">
          <label class="col-md-4 control-label" for="igambar_rencana_prasarana_penggunaan">Gambar Rencana Prasarana penggunaan</label>
          <div class="col-md-6">
            <div class="input-group">
              <input type="file" id="igambar_rencana_prasarana_penggunaan" name="gambar_rencana_prasarana_penggunaan" class="form-control" placeholder="Gambar Rencana Prasarana Penggunaan" accept=".pdf">
              <span class="input-group-addon"><i></i></span>
            </div>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-md-6">
            <div class="row" id="panelfile_gambar_rencana_prasarana_penggunaan">
