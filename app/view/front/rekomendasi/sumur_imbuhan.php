<div class="row">
  <div class="col-md-12">
    ...
    <h1>c. Pembangunan Sumur Imbuhan</h1>
...
<form id="ftambah" action="page_forms_components.html" enctype="multipart/form-data" method="post" class="form-horizontal form-bordered">
  <input type="hidden" name="utype" value="sumur_imbuhan">
...
<div class="row">
  <div class="col-md-12">
      ...
      <div class="form-group">
        <label class="col-md-4 control-label" for="ijika_ada_ke_dalaman_mat">Jika ada, ke dalaman MAT</label>
        <div class="col-md-6">
          <div class="input-group">
            <input type="text" id="ijika_ada_ke_dalaman_mat" name="jika_ada_ke_dalaman_mat" class="form-control" placeholder="Jika ada ke dalaman MAT">
            <span class="input-group-addon"><i></i></span>
          </div>
        </div>
      </div>
...
<div class="row">
  <div class="col-md-12">
      ...
      <div class="form-group">
        <label class="col-md-4 control-label" for="idata_log_bor_dan_desain_sumur">Data Log Bor Dan Desai Sumur</label>
        <div class="col-md-6">
      ...
      <div class="form-group">
        ...
        <div class="col-md-6">
          <div class="input-group">
            <input type="text" id="idata_kualitas_air_hujan" name="data_kualitas_air_hujan" class="form-control" placeholder="Data Kualitas Air Hujan">
            <span class="input-group-addon"><i></i></span>
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-6">
          <div class="input-group">
            <input type="text" id="ijumlah_sumur_yang_sudah_ada" name="jumlah_sumur_yang_sudah_ada" class="form-control" placeholder="Jumlah Sumur Yang Sudah Ada">
            <span class="input-group-addon"><i></i></span>
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-6">
          <div class="row" id="panelfile_jumlah_volume_pengambilan_air_tanah_saat_ini">
      ...
      <div class="form-group">
        <label class="col-md-4 control-label" for="iluas_atap_tangkapan_hujan_yang_akan_digunakan">Luas Atap Tangkapan Hujan Yang Akan Di Gunakan</label>
        <div class="col-md-6">
          <div class="input-group">
            <input type="text" id="iluas_atap_tangkapan_hujan_yang_akan_digunakan" name="luas_atap_tangkapan_hujan_yang_akan_digunakan" class="form-control" placeholder="Luas atap tangkapan hujan yang akan di gunakan">
            <span class="input-group-addon"><i></i></span>
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        <label class="col-md-4 control-label" for="igambar_rencana_desain_bak_pengolah">Gambar Rencana Desain Bak Pengolah</label>
        <div class="col-md-6">
          <div class="input-group">
            <input type="file" id="igambar_rencana_desain_bak_pengolah" name="gambar_rencana_desain_bak_pengolah" class="form-control" placeholder="Gambar rencana desain bak pengolah" accept=".pdf">
            <span class="input-group-addon"><i></i></span>
          </div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-6">
          <div class="row" id="panelfile_gambar_rencana_desain_bak_pengolah">
