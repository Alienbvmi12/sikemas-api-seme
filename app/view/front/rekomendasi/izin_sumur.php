<div class="row">
  <div class="col-md-12">
    <h1>Dokumen Persyaratan Rekomenddasi Teknis</h1>
    <h1>B. Perpanjang izin sumur</h1>
...
<form id="ftambah" action="page_forms_components.html" enctype="multipart/form-data" method="post" class="form-horizontal form-bordered">
  <input type="hidden" name="utype" value="perpanjanganperp_izin_sumur">
...
<div class="row">
  <div class="col-md-12">
      ...
      <div class="form-group">
        ...
        <div class="col-md-6">
          <div class="input-group">
            <input type="text" id="inama_direktur" name="nama_direktur" class="form-control" placeholder="Nama Direktur">
            <span class="input-group-addon"><i></i></span>
          </div>
        </div>
      </div>
...
<div class="row">
  <div class="col-md-12">
      ...
      <div class="form-group">
        ...
        <div class="col-md-6">
          <input type="file" id="idata_log_bor_dan_desain_sumur" name="data_log_bor_dan_desain_sumur" class="form-control" placeholder="Data Log Bor Dan Desain Sumur" accept=".pdf">
        </div>
      </div>
      <div class="form-group">
        <div class="col-md-4">
      ...
      <div class="form-group">
        ...
        <div class="col-md-6">
          <div class="input-group">
            <input type="file" id="idata_logging" name="data_logging" class="form-control" placeholder="Data Logging">
            <span class="input-group-addon"><i></i></span>
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-6">
          <div class="input-group">
            <input type="file" id="idata_kualitas_air_tanah" name="data_kualitas_air_tanah" class="form-control" placeholder="Data Kualitas Air Tanah">
            <span class="input-group-addon"><i></i></span>
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        <label class="col-md-4 control-label" for="igambar_prasarana_penggunaan">Gambar Prasarana Penggunaan</label>
        <div class="col-md-6">
          <div class="input-group">
            <input type="file" id="igambar_prasarana_pengguna" name="laporan_pemakaian_pdam" class="form-control" placeholder="Laporan Pemakaian PDAM" accept=".pdf">
            <span class="input-group-addon"><i></i></span>
          </div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-6">
          <div class="row" id="panelfile_gambar_prasarana_penggunaan">
