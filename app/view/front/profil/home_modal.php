...
<div id="modal_profil_edit" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<!-- Modal Body -->
			<div class="modal-body">
				<form id="fmodal_profil_edit" method="post" enctype="multipart/form-data" action="<?= base_url('profil/edit_profil') ?>" class="form-horizontal">
					<div class="form-group">
						<div class="col-md-12" style="margin-bottom : 10px;">
							<label for="imodal_profil_edit_nama">Nama Depan*</label>
							<input id="imodal_profil_edit_fnama" type="text" name="fnama" class="form-control" value="<?= $sess->user->fnama ?>" required />
						</div>
						<div class="col-md-12" style="margin-bottom : 10px;">
							<label for="imodal_profil_edit_nama">Nama Belakang*</label>
							<input id="imodal_profil_edit_lnama" type="text" name="lnama" class="form-control" value="<?= $sess->user->lnama ?>" required />
						</div>
						<div class="col-md-12">
...
<div id="modal_password_change" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<!-- Modal Body -->
			<div class="modal-body">
				<form id="fmodal_password_change" method="post" enctype="multipart/form-data" action="<?= base_url('profil/edit') ?>" class="form-horizontal">
					<div class="form-group">
						<div class="col-md-12">
						...
						<div class="col-md-12">
							...
							<input id="imodal_password_change_newpassword" type="password" name="newpassword" class="form-control" value="" required />
						</div>
						<div class="col-md-12">
							<label for="imodal_password_change_confirm_newpassword">Confirm New Password *</label>
							<input id="imodal_password_change_confirm_newpassword" type="password" name="confirm_newpassword" class="form-control" value="" required />
						</div>
					</div>
					<div class="form-group">
						<div class="col-md-12">
