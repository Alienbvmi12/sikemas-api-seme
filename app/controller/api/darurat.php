...
class Darurat extends \JI_Controller
{
    ...
    public function emergency_alarm()
    {
        ...
        $this->sendNotificationToTopic("DARURAT", "Tengah terjadi kebakaran di rumah bu Lisa, semua orang yang berada disekitar lokasi diharapkan untuk membantu memadamkan api");
    }
